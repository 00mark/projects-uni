...
{
    float new_matrix[16];
    new_matrix[ 0] = m[0] * other[0][0] + m[4] * other[0][1] + m[ 8] * other[0][2] + m[12] * other[0][3];
    new_matrix[ 1] = m[1] * other[0][0] + m[5] * other[0][1] + m[ 9] * other[0][2] + m[13] * other[0][3];
    new_matrix[ 2] = m[2] * other[0][0] + m[6] * other[0][1] + m[10] * other[0][2] + m[14] * other[0][3];
    new_matrix[ 3] = m[3] * other[0][0] + m[7] * other[0][1] + m[11] * other[0][2] + m[15] * other[0][3];
    new_matrix[ 4] = m[0] * other[1][0] + m[4] * other[1][1] + m[ 8] * other[1][2] + m[12] * other[1][3];
    new_matrix[ 5] = m[1] * other[1][0] + m[5] * other[1][1] + m[ 9] * other[1][2] + m[13] * other[1][3];
    new_matrix[ 6] = m[2] * other[1][0] + m[6] * other[1][1] + m[10] * other[1][2] + m[14] * other[1][3];
    new_matrix[ 7] = m[3] * other[1][0] + m[7] * other[1][1] + m[11] * other[1][2] + m[15] * other[1][3];
    new_matrix[ 8] = m[0] * other[2][0] + m[4] * other[2][1] + m[ 8] * other[2][2] + m[12] * other[2][3];
    new_matrix[ 9] = m[1] * other[2][0] + m[5] * other[2][1] + m[ 9] * other[2][2] + m[13] * other[2][3];
    new_matrix[10] = m[2] * other[2][0] + m[6] * other[2][1] + m[10] * other[2][2] + m[14] * other[2][3];
    new_matrix[11] = m[3] * other[2][0] + m[7] * other[2][1] + m[11] * other[2][2] + m[15] * other[2][3];
    new_matrix[12] = m[0] * other[3][0] + m[4] * other[3][1] + m[ 8] * other[3][2] + m[12] * other[3][3];
    new_matrix[13] = m[1] * other[3][0] + m[5] * other[3][1] + m[ 9] * other[3][2] + m[13] * other[3][3];
    new_matrix[14] = m[2] * other[3][0] + m[6] * other[3][1] + m[10] * other[3][2] + m[14] * other[3][3];
    new_matrix[15] = m[3] * other[3][0] + m[7] * other[3][1] + m[11] * other[3][2] + m[15] * other[3][3];
    return Matrix(new_matrix);
}
...
Matrix Matrix::operator+(const Matrix &other) const
{
    ...
    for(i = 0; i < 4; i++)
    {
        for(j = 0; j < 4; j++)
        {
            new_matrix[i] = m[i * 4 + j] + other[i][j];
        }
    }
 ...
 */
FloatProxy Matrix::operator[](int index) const
{
    if(index < 0 || index > 3)
    {
