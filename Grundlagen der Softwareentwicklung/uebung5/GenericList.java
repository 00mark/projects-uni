...
public class GenericList<T> implements Cloneable{
	   ...
	   public GenericList<T> clone(){
		   try{
			   GenericList<T> copy = (GenericList<T>) super.clone();
			   return copy; 
		   } catch (CloneNotSupportedException e){	// Wird "eigentlich" nicht auftreten
	  ...
	  public boolean equals(GenericList<T> list){
		  if(this.begin.next == list.begin.next && this.begin.o == list.begin.o && this.pos.next == list.pos.next && this.pos.o == list.pos.o ) return true;
		  else return false;
	  }
}
