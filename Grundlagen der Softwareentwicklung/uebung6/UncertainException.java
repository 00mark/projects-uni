public class UncertainException {
   ...
   public int uncertain2() {
      ...
      // Kann nicht auftreten, da der finally Block immer ausgefuehrt wird
      // und dieser durch throw die Methode beendet.
   ...
   // Methode kann eine IOException werfen, welche eine checked Exception ist
   // und muss dies daher in dem Methodenkopf ankuendigen

   //public int uncertain10() {
     public int uncertain10() throws java.io.IOException{
      try {
         throw new java.io.IOException();
      } catch (RuntimeException e) {
      }
